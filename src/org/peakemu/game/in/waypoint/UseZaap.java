 ...
 */
public class UseZaap implements InputPacket<GameClient>{
    final private WaypointHandler waypointHandler;

    public UseZaap(WaypointHandler waypointHandler) {
    ...
    public void parse(String args, GameClient client) {
        ...
        waypointHandler.useZaap(client.getPlayer(), client.getPlayer().getCurrentWaypoint(), map);
    }
