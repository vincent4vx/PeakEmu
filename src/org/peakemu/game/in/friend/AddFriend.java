 ...
 */
public class AddFriend implements InputPacket<GameClient>{
    final private SessionHandler sessionHandler;
    final private AccountHandler accountHandler;

    public AddFriend(SessionHandler sessionHandler, AccountHandler accountHandler) {
    ...
    public void parse(String args, GameClient client) {
        ...
        accountHandler.addToFriends(client.getAccount(), toAdd);
    }
