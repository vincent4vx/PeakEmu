...
//	private int _cellid;
//	private Map<Integer, Item> _object = new TreeMap<Integer, Item>();
//	private long _kamas;
//	private String _key;
...
//
//			Item obj = null;//World.getObjet(guid);
...
//	}
//	
//	public Map<Integer, Item> get_object()
//	{
//		return _object;
//	}
//	
...
//		if(t.isTrunk(P, t))
//		{
//			Database.TRUNK_CODE(P, t, packet);//Change le code
//			t.set_key(packet);
//			closeCode(P);
//		}else
//		{
...
//		
//		if(t == null) return;
//		//if(t.get_owner_id() == P.getAccID() || (P.getGuild() == null ? false : P.getGuild().getSpriteId() == h.get_guild_id() && h.canDo(Constants.C_GNOCODE)))
//		if(t.get_owner_id() == P.getAccID() || (P.getGuild() != null && P.getGuild().get_id() == h.get_guild_id() && h.canDo(Constants.C_GNOCODE)))
//		{
//			OpenTrunk(P, "-", true);
//		}
...
//		{
//			SocketManager.GAME_SEND_ECK_PACKET(P.getAccount().getGameThread(), 5, "");
...
//		}
//		
//		for(Player perso : P.getMap().getPersos())
//		{
...
//		if(P.getInTrunk().get_id() != get_id()) return;
//		
//		Item TrunkObj = World.getObjet(guid);
...
//	{
//		for(Item value : _object.values())
//		{
//			if(value.getTemplate().getType() == ItemType.PIERRE_AME_PLEINE)
//				continue;
//			if(value.getTemplate().getID() == obj.getTemplate().getID() && value.getStats().equals(obj.getStats()))
//				return value;
//		}
//		return null;
//	}
...
//		for(Entry<Integer,Item> entry : _object.entrySet())
//		{
...
//	{
//		for(Entry<Integer, Item> obj : get_object().entrySet())
//		{
