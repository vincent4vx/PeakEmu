...
//					&& toAdd.getObjet().getTemplate().getType() != ItemType.PIERRE_AME_PLEINE;//Récupère les stats de l'objet et compare avec ceux de la ligne
//		}
//		
...
//	{
//		ItemType type = World.getObjTemplate(templateID).getType();
//		
//		return _categories.get(type.getId()).getTemplate(templateID).parseToEHl();
//	}
...
//		int categ = toAdd.getObjet().getTemplate().getType().getId();
...
//			if(toBuy.getOwner() != -1)
//			{
//				Account C = World.getCompte(toBuy.getOwner());
//				if(C != null)
//				{
